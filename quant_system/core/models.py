...
class Position(BaseModel):
    ...
    def apply_trade(self, trade: Trade, t_plus_one: bool = True):
        ...
        if trade.side == OrderSide.BUY:
            total_cost = self.avg_cost * self.quantity + trade.price * trade.quantity + trade.commission + trade.slippage
            ...
            # 计算平仓收益
            pnl = (trade.price - self.avg_cost) * sell_qty - trade.commission - trade.tax - trade.slippage
